...
export const OverviewPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      {/* Header */}
      <div className="flex flex-col sm:flex-row lg:items-end justify-between gap-3 sm:gap-4">
        <div>
          <p className="text-[11px] sm:text-xs font-medium text-slate-400 dark:text-slate-500 flex items-center gap-1.5">
            <CalendarDays className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
            {today}
          </p>
          <h1 className="mt-1 text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <motion.button
            ...
            className="inline-flex items-center gap-1.5 px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-500 shadow-md shadow-indigo-500/20 cursor-pointer"
          >
          ...
          <div className="relative">
            <select
              ...
              className="px-2.5 sm:px-3.5 py-2 rounded-lg text-[11px] sm:text-xs font-medium bg-white dark:bg-[#0e1116] border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-200 shadow-panel focus:outline-hidden cursor-pointer"
            >
