...
export const SubmissionsCRMTable: React.FC<SubmissionsCRMTableProps> = ({
  ...
  return (
    <div className="glass-panel rounded-3xl overflow-hidden">
      {/* Table Toolbar */}
      <div className="p-5 border-b border-slate-200/50 dark:border-white/5 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          ...
          <select
            ...
            className="px-3.5 py-2.5 rounded-xl glass-subtle text-xs font-semibold text-slate-700 dark:text-slate-300 focus:outline-none"
          >
          ...
          <button
            ...
            className="p-2.5 rounded-xl glass-subtle hover:bg-white/50 dark:hover:bg-white/5 text-slate-700 dark:text-slate-300 cursor-pointer transition-colors"
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl glass-subtle hover:bg-white/50 dark:hover:bg-white/5 text-xs font-semibold text-slate-700 dark:text-slate-300 cursor-pointer transition-colors"
          >
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-slate-200/50 dark:border-white/5 bg-slate-50/60 dark:bg-white/5 text-[11px] font-extrabold uppercase tracking-wider text-slate-400">
            ...
            {isLoading ? (
              ...
              filteredSubmissions.map((row) => (
                <tr
                  ...
                  className="hover:bg-white/50 dark:hover:bg-white/5 transition-colors cursor-pointer group"
                >
